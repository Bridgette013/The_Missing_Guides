...
// Fetches nearby hospitals, detox/inpatient facilities, and IOP programs based on ZIP code.
// Returns data structured to match template placeholders:
//   hospitals[0] → PRIMARY_HOSPITAL
//   hospitals[1] → BACKUP_HOSPITAL_1
//   hospitals[2] → BACKUP_HOSPITAL_2
//   inpatientFacilities[0] → INPATIENT_FACILITY_1
//   inpatientFacilities[1] → INPATIENT_FACILITY_2
//   iopFacilities[0] → IOP_FACILITY_1
//   iopFacilities[1] → IOP_FACILITY_2

const GOOGLE_API_KEY = process.env.GOOGLE_PLACES_API_KEY;

// ZIP code to US state mapping (first 3 digits)
const ZIP_STATE_MAP = {
  ...
  '035': 'Vermont', '036': 'Vermont', '037': 'Vermont', '038': 'Vermont',
  '039': 'Maine', '040': 'Maine', '041': 'Maine', '042': 'Maine', '043': 'Maine', '044': 'Maine', '045': 'Maine',
  '046': 'Maine', '047': 'Maine', '048': 'Maine', '049': 'Maine',
  '050': 'Vermont', '051': 'Vermont', '052': 'Vermont', '053': 'Vermont', '054': 'Vermont', '055': 'Vermont',
  ...
  '200': 'District of Columbia', '201': 'Virginia', '202': 'District of Columbia', '203': 'District of Columbia',
  ...
  '537': 'Wisconsin', '538': 'Wisconsin', '539': 'Wisconsin',
  ...
  '556': 'Minnesota', '557': 'Minnesota', '558': 'Minnesota', '559': 'Minnesota',
  ...
  '636': 'Missouri', '637': 'Missouri', '638': 'Missouri', '639': 'Missouri',
  '640': 'Missouri', '641': 'Missouri', '644': 'Missouri', '645': 'Missouri', '646': 'Missouri',
  '647': 'Missouri', '648': 'Missouri', '649': 'Missouri', '650': 'Missouri', '651': 'Missouri',
  '652': 'Missouri', '653': 'Missouri', '654': 'Missouri', '655': 'Missouri', '656': 'Missouri',
  ...
  '740': 'Oklahoma', '741': 'Oklahoma', '743': 'Oklahoma', '744': 'Oklahoma', '745': 'Oklahoma',
  '746': 'Oklahoma', '747': 'Oklahoma', '748': 'Oklahoma', '749': 'Oklahoma',
  ...
  '856': 'Arizona', '857': 'Arizona', '859': 'Arizona', '860': 'Arizona',
...
// Derive state name from ZIP code
